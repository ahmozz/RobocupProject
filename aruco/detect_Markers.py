...
while(True):
    ...
    all_corners = [randint(0,360), randint(0,360), randint(0,360), randint(0,360), randint(0,360), randint(0,360), randint(0,360), randint(0,360)]
    #all_corners = [150,150,150,150,150,150,150,150]

    #json_data = json.dumps(data, separators=(',', ':'))
    buff = struct.pack('f' * len(all_corners), *all_corners)
    #jsona = struct.pack("<I", len(data))
